...
RELAY_URLS_CSV="${MDK_E2E_RELAYS:-$DEFAULT_RELAY_URLS}"
MAX_ATTEMPTS="${MDK_RELAY_WAIT_ATTEMPTS:-20}"
WAIT_INTERVAL="${MDK_RELAY_WAIT_INTERVAL:-0.5}"
CONNECTION_TIMEOUT="${MDK_RELAY_WAIT_TIMEOUT:-3}"
