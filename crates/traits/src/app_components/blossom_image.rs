...
///
/// The key fields are MLS-protected secret material. The custom `Debug`
/// implementation deliberately redacts them.
...
/// Encode group Blossom image state. Present-state media types are normalized
/// with the frozen Marmot media-type algorithm before encoding.
