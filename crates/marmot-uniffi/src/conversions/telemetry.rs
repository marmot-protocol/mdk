...
pub struct AppPerformanceSnapshotFfi {
    ...
    pub account_relay_drain: AppPerformanceOperationSnapshotFfi,
    ...
    pub outbound_message_total_caller_latency: AppPerformanceOperationSnapshotFfi,
    ...
    pub group_create_response_handoff: AppPerformanceOperationSnapshotFfi,
    ...
    pub group_conversation_snapshot_read: AppPerformanceOperationSnapshotFfi,
    ...
    pub media_download_queue_wait: AppPerformanceOperationSnapshotFfi,
    pub media_download_preparation: AppPerformanceOperationSnapshotFfi,
    pub media_download_host_setup: AppPerformanceOperationSnapshotFfi,
    pub media_download_response_headers: AppPerformanceOperationSnapshotFfi,
    pub media_download_first_byte: AppPerformanceOperationSnapshotFfi,
    pub media_download_body_transfer: AppPerformanceOperationSnapshotFfi,
    pub media_download_locator_failover: AppPerformanceOperationSnapshotFfi,
    pub media_download_ciphertext_verify: AppPerformanceOperationSnapshotFfi,
    pub media_download_decrypt: AppPerformanceOperationSnapshotFfi,
...
impl From<marmot_app::AppPerformanceSnapshot> for AppPerformanceSnapshotFfi {
    fn from(value: marmot_app::AppPerformanceSnapshot) -> Self {
        ...
        let marmot_app::AppPerformanceSnapshot {
            ...
            media_upload,
            media_download,
            media_download_queue_wait,
            media_download_preparation,
            media_download_host_setup,
            media_download_response_headers,
            media_download_first_byte,
            media_download_body_transfer,
            media_download_locator_failover,
            media_download_ciphertext_verify,
            media_download_decrypt,
        ...
        Self {
            ...
            account_relay_drain: account_relay_drain.into(),
            ...
            outbound_message_total_caller_latency: outbound_message_total_caller_latency.into(),
            ...
            group_create_response_handoff: group_create_response_handoff.into(),
            ...
            group_conversation_snapshot_read: group_conversation_snapshot_read.into(),
            ...
            media_download_queue_wait: media_download_queue_wait.into(),
            media_download_preparation: media_download_preparation.into(),
            media_download_host_setup: media_download_host_setup.into(),
            media_download_response_headers: media_download_response_headers.into(),
            media_download_first_byte: media_download_first_byte.into(),
            media_download_body_transfer: media_download_body_transfer.into(),
            media_download_locator_failover: media_download_locator_failover.into(),
            media_download_ciphertext_verify: media_download_ciphertext_verify.into(),
            media_download_decrypt: media_download_decrypt.into(),
