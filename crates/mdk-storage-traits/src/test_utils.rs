...
pub mod cross_storage {
    ...
    {
        use crate::groups::{MessageSortOrder, Pagination};
        use nostr::{Kind, PublicKey, Tags, Timestamp, UnsignedEvent};
        ...
        // Message A: created_at=200, processed_at=100  (created early, processed late? no:
        //   created LATER at 200 but processed EARLIER at 100)
        // Message B: created_at=100, processed_at=200  (created earlier but processed later)
        //
        ...
        S: GroupStorage + MessageStorage,
    {
        ...
        let test_data = [
            ("A", [0xA0; 32], 400u64, 100u64),
            ("B", [0xB0; 32], 300u64, 200u64),
            ("C", [0xC0; 32], 200u64, 300u64),
            ("D", [0xD0; 32], 100u64, 400u64),
        ];
