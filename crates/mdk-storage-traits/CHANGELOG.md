...
- **BREAKING**: Changed `WelcomeStorage::pending_welcomes()` to accept `Option<Pagination>` parameter for pagination support ([#110](https://github.com/marmot-protocol/mdk/pull/110))
