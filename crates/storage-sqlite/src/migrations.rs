...
#[path = "migrations/0066_historical_receipt_repair.rs"]
mod migration_0066_historical_receipt_repair;
#[cfg(test)]
...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 66,
        name: "0066_historical_receipt_repair",
        apply: migration_0066_historical_receipt_repair::apply,
    },
];
