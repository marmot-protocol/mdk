...
| `src/account_recovery.rs` | Account-private recovery ledger, evidence import and durable retry reservations; policy and qualified completion remain with the app owner. |
