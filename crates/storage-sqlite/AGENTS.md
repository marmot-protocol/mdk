...
| `src/avatar_cache.rs`, `AVATAR-CACHE.md` | Account-scoped encoded avatar storage, source generations, local reads and eviction; acquisition/native integration are separate. |
