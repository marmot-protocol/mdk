...
c_mirror! {
    ...
    free marmot_app_performance_snapshot_free {
        ...
        rec host_window_init: MarmotAppPerformanceOperationSnapshot,
        rec host_fonts_init: MarmotAppPerformanceOperationSnapshot,
        rec host_runtime_init: MarmotAppPerformanceOperationSnapshot,
        rec host_account_load: MarmotAppPerformanceOperationSnapshot,
        rec host_account_switch: MarmotAppPerformanceOperationSnapshot,
        rec host_frame_update: MarmotAppPerformanceOperationSnapshot,
        rec host_frame_layout: MarmotAppPerformanceOperationSnapshot,
        rec host_frame_draw: MarmotAppPerformanceOperationSnapshot,
        rec host_frame_present: MarmotAppPerformanceOperationSnapshot,
        rec host_chat_list_load: MarmotAppPerformanceOperationSnapshot,
        rec host_contacts_load: MarmotAppPerformanceOperationSnapshot,
        rec host_archived_chat_list_load: MarmotAppPerformanceOperationSnapshot,
        rec host_profile_load: MarmotAppPerformanceOperationSnapshot,
        rec host_profile_read: MarmotAppPerformanceOperationSnapshot,
        rec host_timeline_open: MarmotAppPerformanceOperationSnapshot,
        rec host_timeline_page: MarmotAppPerformanceOperationSnapshot,
        rec host_timeline_handoff: MarmotAppPerformanceOperationSnapshot,
        rec host_timeline_apply: MarmotAppPerformanceOperationSnapshot,
        rec host_message_send: MarmotAppPerformanceOperationSnapshot,
        rec host_message_search: MarmotAppPerformanceOperationSnapshot,
        rec host_conversation_search: MarmotAppPerformanceOperationSnapshot,
        rec host_media_queue_wait: MarmotAppPerformanceOperationSnapshot,
        rec host_media_prepare: MarmotAppPerformanceOperationSnapshot,
        rec host_media_load: MarmotAppPerformanceOperationSnapshot,
        rec host_media_cache_read: MarmotAppPerformanceOperationSnapshot,
        rec host_media_decode: MarmotAppPerformanceOperationSnapshot,
        rec host_media_apply: MarmotAppPerformanceOperationSnapshot,
        rec host_settings_save: MarmotAppPerformanceOperationSnapshot,
    }
}
