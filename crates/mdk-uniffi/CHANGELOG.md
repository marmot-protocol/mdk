...
- Added UniFFI bindings for MIP-06 multi-device methods: `enable_multi_device`, `add_device_to_groups`, `build_pairing_payload`, `join_groups_via_external_commit`, `own_device_leaves`, and `register_join_psk`. ([#251](https://github.com/marmot-protocol/mdk/pull/251))
