...
| `group_profile_projection` | Accepted profile commit advances while the public projection remains stale | Portable expected-value group-profile oracle | group-profile-update/v1 across engine, app-runtime, and process subjects |
