...
| `scheduler_deadline_rearm` | New input after settlement does not re-arm | Shared lifecycle transition plus scheduler model | Virtual-time re-arm and deferred-input scheduler regressions |
...
| `publication_acknowledgement` | Accepted publication remains pending | Shared reference-subject acknowledgement plus pending-work oracle | Lost/duplicate acknowledgement and no-pending-work checks |
