...
| `pairwise_losing_branch_terminalization` | Pairwise recovery permanently drops its provisional loser instead of retaining it for shared depth/witness selection | Route lifecycle model and independent route evaluation | `route_choice_and_restart_do_not_change_the_canonical_winner` and the four-participant cross-route regression family |
