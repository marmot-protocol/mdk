...
| `output_invalidation` | Losing-branch projected output survives | Shared reference evaluation plus application oracle | Losing-app parking/invalidation and exact projection checks |
