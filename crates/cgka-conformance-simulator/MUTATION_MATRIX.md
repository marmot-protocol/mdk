...
| `pairwise_losing_branch_terminalization` | Pairwise routing terminalizes its provisional winner instead of reconsidering the complete durable branch set | Independent route lifecycle model | Reconsiderable-loser engine regressions and the pending cross-route #1236 campaign |
