...
and [#1736](https://github.com/marmot-protocol/mdk/issues/1736). The leave regression now runs ordinarily after the
scheduling correction below; the two concurrent-operation strict journeys remain ignored.
...
Add `--include-ignored` to also run the concurrent-operation strict regressions and, against production maintenance timing, the manual
