...
fn append_app_performance_points(
    ...
    // Host stages measure elapsed spans, including early/error returns.
    ...
    for (name, samples_name, operation) in [
        ...
        (
            ...
            "app_host_window_init_samples",
            &app_performance.host_window_init,
        ),
        (
            "app_host_fonts_init_duration_ms",
            "app_host_fonts_init_samples",
            &app_performance.host_fonts_init,
        ),
        (
            "app_host_runtime_init_duration_ms",
            "app_host_runtime_init_samples",
            &app_performance.host_runtime_init,
        ),
        (
            "app_host_account_load_duration_ms",
            "app_host_account_load_samples",
            &app_performance.host_account_load,
        ),
        (
            "app_host_account_switch_duration_ms",
            "app_host_account_switch_samples",
            &app_performance.host_account_switch,
        ),
        (
            "app_host_frame_update_duration_ms",
            "app_host_frame_update_samples",
            &app_performance.host_frame_update,
        ),
        (
            "app_host_frame_layout_duration_ms",
            "app_host_frame_layout_samples",
            &app_performance.host_frame_layout,
        ),
        (
            "app_host_frame_draw_duration_ms",
            "app_host_frame_draw_samples",
            &app_performance.host_frame_draw,
        ),
        (
            "app_host_frame_present_duration_ms",
            "app_host_frame_present_samples",
            &app_performance.host_frame_present,
        ),
        (
        ...
        (
            ...
            "app_host_chat_list_load_samples",
            &app_performance.host_chat_list_load,
        ),
        (
            "app_host_contacts_load_duration_ms",
            "app_host_contacts_load_samples",
            &app_performance.host_contacts_load,
        ),
        (
            "app_host_archived_chat_list_load_duration_ms",
            "app_host_archived_chat_list_load_samples",
            &app_performance.host_archived_chat_list_load,
        ),
        (
            "app_host_profile_load_duration_ms",
            "app_host_profile_load_samples",
            &app_performance.host_profile_load,
        ),
        (
            "app_host_profile_read_duration_ms",
            "app_host_profile_read_samples",
            &app_performance.host_profile_read,
        ),
        (
            "app_host_timeline_open_duration_ms",
            "app_host_timeline_open_samples",
            &app_performance.host_timeline_open,
        ),
        (
            "app_host_timeline_page_duration_ms",
            "app_host_timeline_page_samples",
            &app_performance.host_timeline_page,
        ),
        (
            "app_host_timeline_handoff_duration_ms",
            "app_host_timeline_handoff_samples",
            &app_performance.host_timeline_handoff,
        ),
        (
            "app_host_timeline_apply_duration_ms",
            "app_host_timeline_apply_samples",
            &app_performance.host_timeline_apply,
        ),
        (
            "app_host_message_send_duration_ms",
            "app_host_message_send_samples",
            &app_performance.host_message_send,
        ),
        (
        ...
        (
            ...
            "app_host_message_search_samples",
            &app_performance.host_message_search,
        ),
        (
            "app_host_conversation_search_duration_ms",
            "app_host_conversation_search_samples",
            &app_performance.host_conversation_search,
        ),
        (
            "app_host_media_queue_wait_duration_ms",
            "app_host_media_queue_wait_samples",
            &app_performance.host_media_queue_wait,
        ),
        (
            "app_host_media_prepare_duration_ms",
            "app_host_media_prepare_samples",
            &app_performance.host_media_prepare,
        ),
        (
            "app_host_media_load_duration_ms",
            "app_host_media_load_samples",
            &app_performance.host_media_load,
        ),
        (
            "app_host_media_cache_read_duration_ms",
            "app_host_media_cache_read_samples",
            &app_performance.host_media_cache_read,
        ),
        (
            "app_host_media_decode_duration_ms",
            "app_host_media_decode_samples",
            &app_performance.host_media_decode,
        ),
        (
            "app_host_media_apply_duration_ms",
            "app_host_media_apply_samples",
            &app_performance.host_media_apply,
        ),
        (
        ...
        (
            ...
            "app_host_settings_save_samples",
            &app_performance.host_settings_save,
        ),
    ] {
        points.push(ExportMetricPoint {
            name,
