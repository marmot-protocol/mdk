...
operations! {
    ...
    HostLinuxStartupBeforeVault => "host_linux_startup_before_vault",
    HostLinuxStartupAfterVault => "host_linux_startup_after_vault",
    HostWindowInit => "host_window_init",
    HostFontsInit => "host_fonts_init",
    HostRuntimeInit => "host_runtime_init",
    HostAccountLoad => "host_account_load",
    HostAccountSwitch => "host_account_switch",
    HostFrameUpdate => "host_frame_update",
    HostFrameLayout => "host_frame_layout",
    HostFrameDraw => "host_frame_draw",
    HostFramePresent => "host_frame_present",
    HostLinuxFramePostPresent => "host_linux_frame_post_present",
    HostLinuxFrameUntilPresent => "host_linux_frame_until_present",
    HostLinuxFrameIdleWait => "host_linux_frame_idle_wait",
    HostChatListLoad => "host_chat_list_load",
    HostContactsLoad => "host_contacts_load",
    HostArchivedChatListLoad => "host_archived_chat_list_load",
    HostProfileLoad => "host_profile_load",
    HostProfileRead => "host_profile_read",
    HostTimelineOpen => "host_timeline_open",
    HostTimelinePage => "host_timeline_page",
    HostTimelineHandoff => "host_timeline_handoff",
    HostTimelineApply => "host_timeline_apply",
    HostMessageSend => "host_message_send",
    HostMessageSearch => "host_message_search",
    HostConversationSearch => "host_conversation_search",
    HostMediaQueueWait => "host_media_queue_wait",
    HostMediaPrepare => "host_media_prepare",
    HostMediaLoad => "host_media_load",
    HostMediaCacheRead => "host_media_cache_read",
    HostMediaDecode => "host_media_decode",
    HostMediaApply => "host_media_apply",
    HostLinuxVaultDeriveKey => "host_linux_vault_derive_key",
    HostLinuxVaultOpen => "host_linux_vault_open",
    HostLinuxVaultCreate => "host_linux_vault_create",
    HostLinuxVaultPersist => "host_linux_vault_persist",
    HostSettingsSave => "host_settings_save",
}
