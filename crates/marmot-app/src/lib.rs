...
use cgka_traits::app_event::{
    ...
    MARMOT_APP_EVENT_KIND_REACTION, MarmotAppEvent as MarmotInnerEvent, STREAM_BROKER_TAG,
    STREAM_ROUTE_TAG, STREAM_TAG,
};
...
use messages::{AppMessageIntent, STREAM_ROUTE_QUIC, build_inner_event, encode_inner_event};
...
mod tests {
    ...
    use cgka_traits::app_event::{
        MARMOT_APP_EVENT_KIND_DELETE, QUOTE_REF_TAG, STREAM_CHUNKS_TAG, STREAM_FINAL_KIND_TAG,
        STREAM_HASH_TAG, STREAM_START_TAG, STREAM_TYPE_TAG,
    };
