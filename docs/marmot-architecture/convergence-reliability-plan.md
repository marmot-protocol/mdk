...
| E13 | `BACKGROUND_CONVERGENCE_BUDGET_MS` | 500 ms | scheduler | Bounds a background advance cooperatively across sweeps, sharing E4's 64-row allowance | Stop between complete operations; persist unfinished generation work and resume before epoch settlement; no asynchronous cancellation or retention extension | intended no | Background row/time/restart tests and strict 1,024-message public recovery |
