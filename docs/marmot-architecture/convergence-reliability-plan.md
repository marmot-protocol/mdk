...
6. [x] Run a focused current-`master` delta campaign for the production convergence changes that landed after the
   ...
   run passed 5/5 at `fd1d9bc0914cdd0e9ad58352c05fc1b7aceed767`; the privately written input manifest has SHA-256
   `48982c7589e4ec9c6f211382f9ed417095e083c0d4b5ba055cfd88c4541f98d6` and the report has SHA-256
   `c254b99cab4722e06aa46a6ba08d6fa2c222b62a68e6820ab77e7b860d8eb58c`.
